...
//Rechte Seite
  //Motor VL
  pcf8574.digitalWrite(0, LOW);  // Motor 1
  pcf8574.digitalWrite(1, HIGH);
  //Motor HL
  pcf8574.digitalWrite(2, LOW);  // Motor 2
  pcf8574.digitalWrite(3, HIGH);
//Linke Seite
  //Motor VR
  pcf8574.digitalWrite(4, HIGH);  // Motor 3
  pcf8574.digitalWrite(5, LOW);
  //Motor HR
  pcf8574.digitalWrite(6, HIGH);  // Motor 4
...
//Rechte Seite
  //Motor VL
  pcf8574.digitalWrite(0, HIGH);  // Motor 1
  pcf8574.digitalWrite(1, LOW);
  //Motor HL
  pcf8574.digitalWrite(2, HIGH);  // Motor 2
  pcf8574.digitalWrite(3, LOW);
//Linke Seite
  //Motor VR
  pcf8574.digitalWrite(4, LOW);  // Motor 3
  pcf8574.digitalWrite(5, HIGH);
  //Motor HR
  pcf8574.digitalWrite(6, LOW);  // Motor 4
